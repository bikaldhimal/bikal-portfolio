...
/**
 * Recharts 3.x tooltip payload item.
 *
 * Recharts has changed the public tooltip prop typings between versions,
 * so we keep the internal payload type intentionally small and compatible.
 */
