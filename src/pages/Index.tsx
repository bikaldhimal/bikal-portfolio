...
const SocialStrip = () => {
    const socials = [
        { label: "GitHub", href: "https://github.com/bikaldhimal" },
        { label: "LinkedIn", href: "https://www.linkedin.com/in/bikaldhimal/" },
        { label: "Instagram", href: "https://www.instagram.com/bikal24525/" },
        { label: "Email", href: "mailto:bikaldhimal2016@gmail.com" },
    ];
    return (
        <motion.div
        ...
        <a href="#contact" className="cta-wrap group relative flex items-center justify-center w-[130px] h-[130px]" aria-label="Get in touch">
            ...
            <svg viewBox="0 0 130 130" className="cta-ring absolute inset-0 w-full h-full pointer-events-none">
                ...
                <text fill="rgba(255,255,255,1)" fontSize="8.5" fontFamily="'Inter', sans-serif" fontWeight="900" letterSpacing="4">
                    <textPath href="#cta-circle-path">START A PROJECT · START A PROJECT · START A PROJECT ·&nbsp;</textPath>
                </text>
            </svg>
...
//   const socials = [
//     { label: "Github", icon: Github, href: "https://github.com/bikaldhimal" },
//     { label: "LinkedIn", icon: Linkedin, href: "https://www.linkedin.com/in/bikaldhimal/" },
//     { label: "Instagram", icon: Instagram, href: "https://www.instagram.com/bikal24525/" },
//     { label: "Email", icon: Mail, href: "mailto:bikaldhimal2016@gmail.com" },
//   ];
//   return (
//     <motion.div
//       initial={{ opacity: 0, x: 20 }}
                ...
                <div className="z-10 mt-auto mb-6 md:mb-8">
                    ...
                    >
                        <a href="#contact" className="group relative overflow-hidden border border-white/30 px-5 py-3 flex items-center gap-3 hover:border-white transition-colors duration-500 w-fit mb-6 md:hidden">
                            ...
                            <span className="relative font-sans font-black text-[10px] tracking-[0.25em] uppercase text-white group-hover:text-black transition-colors duration-300 z-10">Start a project</span>
                ...
                <div className="z-10 grid grid-cols-1 md:grid-cols-12 w-full gap-4 mb-8 md:mb-0">
                    ...
                    >
                        ...
                        <p className="font-sans text-xs md:text-sm font-medium text-white leading-relaxed tracking-wide uppercase text-left">
                            Building scalable software, automating complex workflows, and transforming systems with intelligent technology.
                        </p>
                    </motion.div>
                </div>
            </section>
